...
config_path = PathJoinSubstitution(
        [FindPackageShare("quadruped_gazebo"), "config", "go1_ros_control.yaml"]
    )
...
robot_description = ParameterValue(Command(['xacro ', PathJoinSubstitution([str(pkg_path), 'urdf/go1/go1.urdf'])]))
