...
description_path = PathJoinSubstitution(
        [FindPackageShare("quadruped_description"), "launch", "a1_lidar_description.launch.py"]
    )


    

robot_description = ParameterValue(Command(['xacro ', PathJoinSubstitution([str(pkg_path), 'urdf/a1/a1_with_lidar.urdf.xacro'])]))
